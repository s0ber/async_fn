/*! async_fn (v0.1.0),
 ...
 Sat Aug 23 2014 */
(function(){var n;n={},null==window.modula&&(window.modula={"export":function(t,e){return n[t]=e},require:function(t){var e;if(e=n[t])return e;throw"Module '"+t+"' not found."}})}).call(this),function(){window.AsyncFn=function(){function n(n){this.fn=n}return n.prototype.done=function(n){return this.callback=n,this.isCalled?this.callback():void 0},n.prototype.call=function(){return this.isCalled?void 0:this.fn().always(function(n){return function(){return n.isCalled=!0,n.callback?n.callback():void 0}}(this))},n.addToCallQueue=function(t){var e;return e=new n(t),null!=this.currentFn?this.currentFn.done(function(){return function(){return e.call()}}(this)):e.call(),this.currentFn=e},n.setImmediate=function(){var n,t,e,i;return t={},i=t,n=Math.random(),e=function(e){var i;if(e.data===n)return t=t.next,i=t.func,delete t.func,i()},window.addEventListener?window.addEventListener("message",e,!1):window.attachEvent("onmessage",e),window.postMessage?function(t){return i=i.next={func:t},window.postMessage(n,"*")}:function(n){return setTimeout(n,0)}}(),n}(),modula["export"]("async_fn",AsyncFn)}.call(this);